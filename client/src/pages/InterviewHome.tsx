...
const PREP_CARDS: SectionCard[] = [
  ...
  { icon: '📚', title: 'Core CS Drills', desc: 'CN, OS, DBMS & SQL subject practice & theory drills.', page: 'core-cs-hub' },
  { icon: '🎯', title: 'Quests', desc: 'Auto-generated diagnostic learning paths & XP rewards.', page: 'quests-hub' },
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 rounded-2xl shadow-lg p-8 text-white mb-8">
          ...
          <div className="flex flex-wrap gap-3 mt-5">
            <button
              ...
              className="px-5 py-2.5 rounded-full font-black text-sm bg-emerald-400 text-slate-950 hover:bg-emerald-300 transition shadow"
            >
